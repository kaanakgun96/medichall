...
(function () {
  ...
  const navigation = {
    public: [
      ...
      ["manufacturers", "Manufacturers", "companies.html"],
        ...
        <header class="mh-header">
          <div class="mh-header__inner">
            ...
            <form class="mh-header-search" action="/products.html" method="get" role="search">
              ${icons.search}<label class="mh-sr-only" for="mh-search-${mode}">Search products and manufacturers</label>
              <input id="mh-search-${mode}" name="q" type="search" autocomplete="off" placeholder="Search products and manufacturers">
            </form>
