...
test("root pages load one canonical session helper before shared navigation", () => {
  ...
  assert.deepEqual([...releaseVersions].sort(), ["20260809s22rc1", "20260810beta1", "20260811tax1", "20260813growth1", "20260813traffic1", "20260813video1", "20260817draft1", "20260817privacy1"].sort());
});
