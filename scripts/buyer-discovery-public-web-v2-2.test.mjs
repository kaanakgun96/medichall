...
assert.match(provider, /maximumQueries: 6/);
assert.match(provider, /maximumResultsPerQuery: 6/);
assert.match(provider, /maximumRawResults: 36/);
assert.match(provider, /maximumCandidates: 20/);
...
assert.match(provider, /maximumCostUsdPerRun: 0\.03/);
